...
namespace ParkwayNorthEvents.Pages.User.MyEvents
{
    public class UpdateEventModel : PageModel
    {
        ...
        public UpdateEventModel(IUnitOfWork unitOfWork, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            return RedirectToPage("/User/MyEvents/Edit", new { id = BookingObject.BookingId });
